...
const stats = [
  { label: 'ارزش کل دارایی', value: '۱۲.۸۴ میلیارد', suffix: 'تومان', change: '+۱۸.۲٪', up: true, icon: WalletCards, accent: 'from-blue-500 to-sky-400' },
  { label: 'سود امروز', value: '۳۸۷.۵ میلیون', suffix: 'تومان', change: '+۴.۷٪', up: true, icon: TrendingUp, accent: 'from-emerald-500 to-teal-400' },
  { label: 'ریسک فعال', value: '۳۴', suffix: 'از ۱۰۰', change: '-۲.۱٪', up: true, icon: ShieldCheck, accent: 'from-indigo-500 to-blue-400' },
  { label: 'هشدارهای باز', value: '۹', suffix: 'مورد', change: '+۳ جدید', up: false, icon: Bell, accent: 'from-amber-500 to-orange-400' },
];
