...
const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: 'اختاپوس یک اپ PWA است — از مرورگر موبایل (Chrome یا Safari) وارد شوید و گزینه «افزودن به صفحه اصلی» را انتخاب کنید تا مانند یک اپ نصب شود.',
  },
];
...
const TIPS = [
  ...
  },
  {
    ...
    body: 'در Chrome موبایل از منو «Add to Home Screen» را انتخاب کنید. اختاپوس مانند یک اپ نصب می‌شود — بدون App Store.',
  },
];
      ...
      <div className="flex-1 min-w-0 space-y-5">
        ...
        {active === 'getting-started' && (
          <div className="space-y-5">
            <div>
              <h2 className="text-xl font-black text-white">شروع به کار با اختاپوس</h2>
