...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'nav.item.Iran Market News': 'Iran Market News',
    'nav.item.Price Alerts': 'Price Alerts',
  ...
  es: {
    ...
    'nav.item.Iran Market News': 'Noticias del mercado iraní',
    'nav.item.Price Alerts': 'Alertas de precio',
  ...
  fa: {
    ...
    'nav.item.Iran Market News': 'اخبار بازار ایران',
    'nav.item.Price Alerts': 'هشدار قیمت',
